    ...
    return(
        <div id="project">
            ...
            <div className="project-row">
                ...
                <ProjectApp isDemo={true} describe={"A Scratch project that scans a picture first, then lets you freely draw and explore your creativity."} tech={["Scratch"] } image={scanner} linkDemo={"https://scratch.mit.edu/projects/1186193801/"}>Picture Scanner</ProjectApp>
                <ProjectApp isDemo={true} describe={"A Scratch project that lets users enter a date and instantly finds the day of the week for it."} tech={["Scratch"] } image={day} linkDemo={"https://scratch.mit.edu/projects/1186950838/"}>Day Finder</ProjectApp>
            </div>
        </div>
    );
}